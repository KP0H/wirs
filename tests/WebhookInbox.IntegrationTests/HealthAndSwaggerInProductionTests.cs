...
public class HealthAndSwaggerInProductionTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;
    public HealthAndSwaggerInProductionTests(WebApplicationFactory<Program> factory)
    {
        _client = factory.WithWebHostBuilder(b => b.UseSetting("ENVIRONMENT", "Production")).CreateClient();
    }
    ...
    [Fact]
    public async Task SwaggerJson_Should_Return_404_In_Production()
    {
